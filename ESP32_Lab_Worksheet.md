...
1. เปรียบเทียบประสบการณ์การใช้ Docker ในสัปดาห์นี้กับสัปดาห์ที่ 4:
   สัปดาห์ที่ 4 ยังงง ๆ กับคำสั่งพื้นฐาน แต่สัปดาห์นี้เริ่มเข้าใจมากขึ้น ใช้ Docker Compose ได้ และเชื่อมต่อหลาย container ได้เองแล้ว

2. สิ่งที่เรียนรู้เพิ่มเติมเกี่ยวกับ ESP32 architecture:
   ESP32 มีสองคอร์ รองรับ Wi-Fi กับ Bluetooth ในตัว แล้วก็มีพอร์ตเชื่อมต่อหลายแบบ ใช้ FreeRTOS จัดการงานได้ดี

3. ความท้าทายที่พบในการทำ architecture analysis:
   ยากตรงการเข้าใจโครงสร้างภายใน ESP32 กับการเชื่อมต่อแต่ละส่วน ต้องอ่านเอกสารเยอะและลองผิดลองถูกเยอะหน่อย
---
